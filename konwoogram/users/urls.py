...
urlpatterns = [
    ...
    path("<str:username>/followers", view=views.UserFollowers.as_view() , name="user_follow"),
    path("<str:username>/following", view=views.UserFollowings.as_view() , name="user_following"),
